  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. 7021738833</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">JoB HuNT<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Arthur Road, Near Nirmala hospital<br>
           Pin-400011 Mumbai, India.</address>
          <p>
            <i class="icon-phone"></i> 8850732616 <br>
            <i class="icon-envelope-alt"></i> aryan.sadvelkar@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
